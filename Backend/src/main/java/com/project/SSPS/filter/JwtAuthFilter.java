package com.project.SSPS.filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(JwtService jwtService, UserDetailCustom userDetailCustom) {
    ...
    protected void doFilterInternal(
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = userDetailCustom.loadUserByUsername(username);
